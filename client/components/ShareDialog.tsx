...
const socialPlatforms = [
    {
        ...
        color: "bg-success/10 text-success hover:bg-success/20 border-success/20",
    ...
    },
    {
        ...
        color: "bg-info/10 text-info hover:bg-info/20 border-info/20",
    ...
    },
    {
        ...
        color: "bg-warning/10 text-warning hover:bg-warning/20 border-warning/20",
    ...
    },
    {
        ...
        color: "bg-ai/10 text-ai hover:bg-ai/20 border-ai/20",
    ...
    return (
        <>
            ...
            <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[460px] max-w-[92vw]">
                <div className="overflow-hidden rounded-2xl border border-border bg-card/95 shadow-soft backdrop-blur-2xl animate-in zoom-in-95 duration-200">
                    {/* Header */}
                    ...
                    <div className="p-5 space-y-5">
                        ...
                        {inviteCode && (
                            <div className="space-y-2">
                                <label className="text-xs font-semibold text-muted-foreground uppercase">Invite Code</label>
                                <div className="flex items-center gap-2 p-1 bg-muted/50 border border-border/50 rounded-xl">
                                <span className="flex-1 px-3 py-2 text-center font-mono text-2xl font-bold">
                                    {inviteCode}
                                </span>
                                    <button
                        ...
                        <div className="space-y-3">
                            <label className="text-xs font-semibold text-muted-foreground uppercase">Share via</label>
